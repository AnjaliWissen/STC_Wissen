...
export default function SystemSettingsPage() {
  ...
  mutationFn: async (payload: Config) => {
    const res = await fetch(`${BASE_URL}/config`, {
      ...
      body: JSON.stringify({
        autoEOD: payload.autoEOD,
        autoStellar: payload.autoStellar,
      ...
      <div className="flex justify-between items-center">
        <div>
          ...
          <p className="text-gray-500 mt-1">
            Configure automation and settlement rules
          </p>
        </div>
        <Button
    ...
    />
        ...
        <Card className="bg-gradient-to-br from-white to-purple-50/30 dark:from-gray-800 dark:to-purple-900/10">
          ...
          <CardContent className="space-y-4">
            <div className="flex justify-between">
              ...
              <Switch
                checked={formData.settlement.allowPartialSettlement}
                onCheckedChange={(v) =>
                  setFormData({
                    ...formData,
                    settlement: {
                      ...formData.settlement,
                      allowPartialSettlement: v,
                    },
                  })
                }
              />
            ...
            <div className="flex justify-between">
              <Label>Require Net Match</Label>
              <Switch
                checked={formData.settlement.requireNetPositionMatch}
                onCheckedChange={(v) =>
                  setFormData({
                    ...formData,
                    settlement: {
                      ...formData.settlement,
                      requireNetPositionMatch: v,
                    },
                  })
                }
              />
        ...
        <Card className="bg-gradient-to-br from-white to-amber-50/30 dark:from-gray-800 dark:to-amber-900/10">
          ...
          <CardHeader>
            ...
            <CardDescription>Read-only from backend</CardDescription>
          </CardHeader>
          <CardContent className="space-y-2">
            {formData.settledPeriods.map((p) => (
              <div
                key={p}
